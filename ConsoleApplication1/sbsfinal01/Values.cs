...
{
    internal partial class Values : IServiceOperations<Sbsfinal01>, IValues
    {
        /// <summary>
        ...
        /// </param>
        internal Values(Sbsfinal01 client)
        {
            this._client = client;
        }
        
        private Sbsfinal01 _client;
        
        /// <summary>
        /// Gets a reference to the ConsoleApplication1.Sbsfinal01.
        /// </summary>
        public Sbsfinal01 Client
        {
